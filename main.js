...
var GitCommitView = class extends import_obsidian3.ItemView {
  ...
  createHeader(container) {
    ...
    this.commitButton = new import_obsidian3.ButtonComponent(buttonsContainer).setIcon("check").setTooltip("\u63D0\u4EA4").onClick(async () => {
  ...
  createCommitMessageSection(container) {
    ...
    this.commitMessageTextarea = new import_obsidian3.TextAreaComponent(messageSection);
  ...
  createButtonSection(container) {
    ...
    this.pushButton = new import_obsidian3.ButtonComponent(buttonSection).setButtonText("\u{1F680} \u63A8\u9001").setClass("git-push-button").onClick(async () => {
  ...
  createChangesGroup(container, title, changes, isStaged) {
  ...
  async performCommit() {
    ...
    if (selectedFiles.length === 0) {
      new import_obsidian3.Notice("\u274C \u6CA1\u6709\u8981\u63D0\u4EA4\u7684\u6587\u4EF6");
      return;
    }
    try {
      (_a = this.commitButton) == null ? void 0 : _a.setButtonText("\u63D0\u4EA4\u4E2D...");
      (_b = this.commitButton) == null ? void 0 : _b.setDisabled(true);
      ...
      (_c = this.commitButton) == null ? void 0 : _c.setButtonText("\u{1F4BE} \u63D0\u4EA4");
      (_d = this.commitButton) == null ? void 0 : _d.setDisabled(false);
    }
  }
  async performPush() {
    var _a, _b, _c, _d;
    try {
      (_a = this.pushButton) == null ? void 0 : _a.setButtonText("\u63A8\u9001\u4E2D...");
      (_b = this.pushButton) == null ? void 0 : _b.setDisabled(true);
      await this.plugin.pushToRemoteRepository();
      new import_obsidian3.Notice("\u2705 \u63A8\u9001\u6210\u529F");
      await this.resetToInitialState();
    } catch (error) {
      console.error("\u63A8\u9001\u5931\u8D25:", error);
      new import_obsidian3.Notice(`\u274C \u63A8\u9001\u5931\u8D25: ${error.message}`);
      (_c = this.pushButton) == null ? void 0 : _c.setButtonText("\u{1F680} \u63A8\u9001");
  ...
  showPostCommitState() {
    ...
    (_b = this.pushButton) == null ? void 0 : _b.buttonEl.style.setProperty("display", "inline-block");
  }
  showSuccessMessage() {
    if (!this.changesContainer)
      return;
...
var GitAutoCommitPlugin = class extends import_obsidian4.Plugin {
  ...
  async activateGitCommitView() {
    ...
    let leaf;
    if (leaves.length === 0) {
      leaf = (_a = this.app.workspace.getRightLeaf(false)) != null ? _a : this.app.workspace.getLeaf();
...
var GitAutoCommitSettingTab = class extends import_obsidian4.PluginSettingTab {
  ...
  display() {
    ...
    new import_obsidian4.Setting(containerEl).setName("\u5305\u542B\u7684\u6587\u4EF6\u7C7B\u578B").setDesc("\u8981\u5305\u542B\u5728\u63D0\u4EA4\u4E2D\u7684\u6587\u4EF6\u6269\u5C55\u540D\uFF08\u7528\u9017\u53F7\u5206\u9694\uFF09").addText((text) => text.setPlaceholder(".md,.txt,.canvas,.json").setValue(this.plugin.settings.includeFileTypes.join(",")).onChange(async (value) => {
