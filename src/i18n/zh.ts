export default {
    ...
    "Failed to validate API Key. Please check your key and try again.": "验证 API 密钥失败，请检查密钥并重试。",
    ...
    "Ollama service is not running. Please start the service.": "Ollama 服务未运行，请启动服务。",
    "Check": "验证",
    "Server URL": "服务器 URL",
    ...
    "Input message...": "输入消息...",
    "Context Preview & Settings": "上下文预览与设置",
    "Preview Content (Auto-update)": "预览内容（自动更新）",
    "Apply": "应用",
    "Please configure AI service in settings": "请在设置中配置AI服务",
    "Open Settings": "打开设置",
