...
function addCopyHashMenuItem(commit: CtxMenuCommitInfo, menu: Menu) {
    menu.addItem((item) =>
        item
            .setTitle(t("lineAuthor.copyCommitHash"))
            .setIcon("copy")
...
function addConfigurableLineAuthorSettings(
    ...
    if (key === "showCommitHash") {
        title = t("lineAuthor.showCommitHash");
        ...
        title = t("lineAuthor.showAuthor") + " " + (currentlyShown ? currentValue : showOption);
        ...
        title = t("lineAuthor.showDate") + " " + (currentlyShown ? currentValue : showOption);
